...
| T-012 | [ ] | `docker-compose.yml` | [RDO-001](../Requirements/Requirements.md#11-requerimientos-devops) · [EP-0.4](../Execution%20Plan/ExecutionPlan.md#04-create-docker-base) | `Crea docker-compose.yml con postgres y backend según EP-0.4 y RDO-001. Lee AGENTS.md.` |
| T-013 | [ ] | `Dockerfile` backend | [RDO-001](../Requirements/Requirements.md#rdo-001) | `Crea Dockerfile para FastAPI en backend/. Multi-stage si aplica.` |
| T-014 | [ ] | `.env.example` | [RDO-020](../Requirements/Requirements.md#rdo-020) | `Genera .env.example con DATABASE_URL, JWT_SECRET, etc.` |
